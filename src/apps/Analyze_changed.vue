<template>
  <div id="App"
    ...
    <!--<div class="uk-width-1-1 uk-grid app-bottom clear-grid-margin" :class="{'app-bottom-top': timeLineState==='top'}">-->
      ...
      <div class="project uk-width-1-3 uk-panel app-bottom clear-grid-margin">
        <project></project>
      </div>
      <!--<div class="time-line uk-width-2-3 uk-panel">-->
      <div class="time-line uk-width-2-3 uk-panel app-bottom clear-grid-margin" :class="{'app-bottom-top': timeLineState==='top'}">
        <time-line></time-line>
      </div>
    <!--</div>-->
  </div>
